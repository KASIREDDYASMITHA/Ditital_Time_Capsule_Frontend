...
//   return (
//     <div className="min-h-screen px-10 py-10 bg-background text-foreground">
...
//         {/* DARK MODE */}
//         <div className="p-6 rounded-2xl bg-card shadow flex justify-between items-center">
//           <div>
...
// import { useEffect, useState } from "react";
// import axios from "axios";
// import { User, KeyRound, Eye, EyeOff, Bell } from "lucide-react";
...
//             <Bell size={22} />
//             <div>
//               <h2 className="text-xl font-semibold">Unlock Alerts</h2>
//               <p className="text-sm opacity-70">
//                 Get notified when your capsule unlocks
//               </p>
//             </div>
//           </div>
...
//             className="px-5 py-2 rounded-full bg-muted"
//           >
//             {unlockAlerts ? "Enabled" : "Disabled"}
//           </button>
//         </div>
