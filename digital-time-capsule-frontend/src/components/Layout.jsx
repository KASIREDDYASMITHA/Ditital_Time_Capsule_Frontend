...
//   return (
//     <div className="min-h-screen bg-white dark:bg-[#0b0b15] transition-colors duration-300">
      
//       {/* ================= NAVBAR ================= */}
//       <nav className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#0b0b15]">
...
//           <button
//             onClick={toggleTheme}
//             className="p-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 hover:scale-105 transition"
//           >
//             {darkMode ? (
...
//           <Link
//             to="/login"
//             className="font-medium text-gray-800 dark:text-white hover:text-indigo-500 transition"
//           >
//             Log in
//           </Link>
